...
<p style="text-align: center;"><a href="/assets/posts{{page.path | remove: ".md" | remove: "_posts" }}/drawing1.jpg }}"><img class="size-medium wp-image-472  aligncenter" title="tap4j" src="/assets/posts{{page.path | remove: ".md" | remove: "_posts" }}/drawing1-300x265.jpg" alt="" width="300" height="265" /></a></p>
