...
if __name__ == '__main__':
    ...
    T1 = TDigest(delta=0.38, K=25)

    for x in range(0, 100):
        T1.update(x=random.random() * 100, w=1)

    print(f"Min is {min(T1.C)}, max is {max(T1.C)}")
    print(f"Count is {len(T1.C)}, there are {len([c for c in T1.C.keys()])} centroids")
    for id, centroid in T1.C.items():
        print(f"Centroid {id}, mean {centroid.mean} data is {centroid.count}...")
    ...
```
...
```bash
Min is 1.9476742385832302, max is 97.9756131334175
Count is 16, there are 16 centroids
Centroid 1.9476742385832302, mean 1.9476742385832302 data is 1.0...
Centroid 2.5010755222666936, mean 2.5010755222666936 data is 1.0...
Centroid 4.5824383655662215, mean 4.5824383655662215 data is 1.0...
Centroid 6.552783047406203, mean 6.552783047406203 data is 5.0...
Centroid 8.625981554607305, mean 8.625981554607305 data is 3.0...
Centroid 13.904307344000102, mean 13.904307344000102 data is 10.0...
Centroid 23.9899680420278, mean 23.9899680420278 data is 14.0...
Centroid 37.64405610412603, mean 37.64405610412603 data is 8.0...
Centroid 55.503282774542804, mean 55.503282774542804 data is 18.0...
Centroid 66.62945140835477, mean 66.62945140835477 data is 7.0...
Centroid 74.31328596589631, mean 74.31328596589631 data is 11.0...
Centroid 84.11225268395795, mean 84.11225268395795 data is 11.0...
Centroid 88.4851453543234, mean 88.4851453543234 data is 3.0...
Centroid 94.43668559566355, mean 94.43668559566355 data is 3.0...
Centroid 96.28520131955972, mean 96.28520131955972 data is 2.0...
Centroid 97.9756131334175, mean 97.9756131334175 data is 2.0...
```
